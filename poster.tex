...
%
\note[rotate=0, width = 9cm, height= 0.5cm,
%roundedcorners=15, 
targetoffsetx=+17cm, %-0.01\textwidth,
targetoffsety=+40cm]{
{\small Version 1.1/20220929}}
%0/20220627}}


%
\note[rotate=8, connection, width = 13cm,
%roundedcorners=15, 
targetoffsetx=+15cm, %-0.01\textwidth,
targetoffsety=-30cm]{\includegraphics[width=1.0\linewidth]{TMUH_Wu_QRcode.png}\\
{\Huge 我要你!}}

%
\note[rotate=0, width = 40cm, height= 0.5cm,
%roundedcorners=15, 
targetoffsetx=-18cm, %-0.01\textwidth,
targetoffsety=-40cm]{
{\small 本招募廣告經臺北醫學大學暨附屬醫院聯合人體研究倫理委員會審查核准，轉載(貼)不得修改內容 (圖片來源iStock)}}
...
\begin{outline}
    ...
    \1  受試者應配合之事項：授權提供「切片檢體」、血液、唾液，以供數位病理影像分析、血清與唾液的基因體分析。並接受每三個月門診定期追蹤(至少三年)。我們的醫師、護理師與工作人員，很樂意詳細為您解說。(QR code 口腔顎面外科門診)
\end{outline}
% 亦請參考計畫書及
...
%\1 參加者資格
    \1 若具有以下資格，我們歡迎您的加入：
        ...
        \2 對照組之健康人(口腔黏膜正常者)： 經臨床判斷，僅收集血液、唾液
